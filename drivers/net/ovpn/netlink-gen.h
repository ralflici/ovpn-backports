...
extern const struct nla_policy ovpn_peer_nl_policy[OVPN_A_PEER_SPORT_ENTROPY_RX + 1];
extern const struct nla_policy ovpn_peer_del_input_nl_policy[OVPN_A_PEER_ID + 1];
extern const struct nla_policy ovpn_peer_new_input_nl_policy[OVPN_A_PEER_SPORT_ENTROPY_RX + 1];
