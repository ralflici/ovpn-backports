...
#define dev_dstats_rx_dropped(dev) dev_core_stats_rx_dropped_inc(dev)
	...
	OVPN_SLE_VERSION_CODE_LT(15, 5, 0) && \
	RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(8, 10)
...
#endif /* LINUX_VERSION_CODE < KERNEL_VERSION(5, 19, 0) && OVPN_SLE_VERSION_CODE_LT(15, 5, 0) && RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(8, 10) */
